...
class AuthController extends Controller
{
    ...
    public function register(Request $request) //za kada se prvi put logujemo
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'slika'  =>  'nullable|image|mimes:jpg, jpeg, png|max:2048' //za opciono ubacivanje profilne slike korisnika
        ]);
       ...
       // ako je korisnik dodao sliku, dodajemo putanju
        ...
        $user = User::create([
            ...
            'profile_photo_path' =>  $data['slika'] // sada će biti ili putanja ili null
        ]);
